...
public struct OnDappEventObserveurs
{
}
...
public class DapManager : NetworkBusListener
{
    ...
    [Header("Bars Settings")] [SerializeField]
    private float _maxEnergy = 100f;

    [SerializeField] public Transform _dapBarParent;

    [Header("Dap Settings")] [SerializeField, Tooltip("0 = Arene 1 / 1 = Arene 2 / 2 = Arene 3 / 3 = Tuto")]
    private float[] _percentageGainPerSecond;
    ...
    private float _idleTimeToTrigger = 20f;
